...
const LeftSidebarHeader: React.FC = () => {
  ...
  return (
    <div
      className="relative pb-6 mb-6 border-b font-plus 
    ...
    >
      ...
      >
        <img
          ...
          src="https://i.pinimg.com/736x/81/7c/4b/817c4bcdb0674e9ca636493bdc9e5c25.jpg"
        />
      ...
      {isOpen && (
        <div
          className="absolute top-full mt-3 left-0 w-full z-10 rounded-md shadow-lg 
